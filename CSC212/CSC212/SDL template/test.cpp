...
int main(int argc, char* argv[]) {
    ...
    backgroundTextures.push_back(loadTexture("./assets/pixelforest/skytoon.jpg"));
    backgroundTextures.push_back(loadTexture("./assets/pixelforest/cartoongrass.png"));
    backgroundTextures.push_back(loadTexture("./assets/pixelforest/trees.png"));
    ...
    SDL_Texture* backgroundSky = loadTexture("./assets/bluesky2.jpg");
